...
allTheSuits r =(Add(Card Ace r )(Add(Card King r )(Add(Card Queen r )(Add (Card Jack r)(Add (Card (Numeric x) r)Empty)))))
	where
		( x <= [2..10])
...
--Have to check for the recursion of all the cards though :9
